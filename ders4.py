...
url = f"https://query1.finance.yahoo.com/v7/finance/download/{stock_name}?period1={from_epoch}&period2={to_epoch}&interval=1d&events=history&includeAdjustedClose=true"
